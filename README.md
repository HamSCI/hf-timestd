...
- **[Station-network capabilities](https://github.com/HamSCI/sigmond/blob/main/docs/STATION-NETWORK-CAPABILITIES.md)** (sigmond docs) — what a *mesh* of these stations delivers beyond a single node (TID imaging, common-illuminator gradient sensing, tomography) and why the network is resilient to the loss of any one transmitter, CHU included.
