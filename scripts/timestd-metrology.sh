#!/bin/bash
# =============================================================================
# TimeStd Metrology Service Launcher
# =============================================================================
# Launches one metrology_service instance per channel (9 total).
#
...
start)
    ...
    # Precise coordinates for improved timing accuracy
...
stop)
    echo "🛑 Stopping Metrology Services..."
