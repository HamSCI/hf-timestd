...
| **T3** | HF Fusion (multi-station *received* time-signal consensus, no local GPS).                                     | sub-ms via consensus across WWV/WWVH/BPM etc. The regime our remote stations will operate in. |
